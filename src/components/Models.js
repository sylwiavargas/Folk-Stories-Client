...
// red - joint
  ...
  render() {
    const nodes = [
      ...
      {id: "year_eras", color: "#d9c60f", size: 500},
      ...
      {id: "places_people", color: "#d9c60f", size: 500},
